$(document).ready (function(){
  ...
  $('#assholeBtn').click(function(event){
    selectNews(event);
  });
  $('#buttonDiv').on('click', '#closeButton',function() {
    openMenu()
  });
  ...
  function selectNews(event){
    ...
    if($('#done').length == 0){
      ...
      $('<button id="done" class="animated wobble source">  <h3 id="closeButton"> Done!</h3> </button>').insertAfter('#assholeBtn');
    }
